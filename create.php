...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validacao) {
        ...
        $sql = "INSERT INTO pessoa (nome, curso, telefone, email, periodo) VALUES(?,?,?,?,?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $curso, $telefone, $email, $periodo));
        Banco::desconectar();
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="create.php" method="post">
                        ...
                        <div class="control-group <?php echo !empty($enderecoErro) ? 'error ' : ''; ?>">
                            ...
                            <div class="controls">
                                <input size="80" class="form-control" name="curso" type="text" placeholder="Curso" value="<?php echo !empty($curso) ? $curso : ''; ?>">
                        ...
                        <div class="control-group <?php !empty($periodoErro) ? '$periodoErro ' : ''; ?>">
                            <label class="control-label">Periodo</label>
                            <div class="controls">
                                <input size="40" class="form-control" name="periodo" type="text" placeholder="periodo" value="<?php echo !empty($periodo) ? $periodo : ''; ?>">
                                <?php if (!empty($periodoErro)) : ?>
                                    <span class="text-danger"><?php echo $periodoErro; ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
