...
if (!empty($_POST)) {
    ...
    if ($validacao) {
        ...
        $sql = "UPDATE pessoa  set nome = ?, curso = ?, telefone = ?, email = ?, periodo = ? WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $curso, $telefone, $email, $periodo, $id));
        Banco::desconectar();
        header("Location: index.php");
    }
} else {
            ...
            <div class="card-body">
                <form class="form-horizontal" action="update.php?id=<?php echo $id ?>" method="post">
                    ...
                    <div class="control-group <?php echo !empty($enderecoErro) ? 'error' : ''; ?>">
                        ...
                        <div class="controls">
                            <input name="curso" class="form-control" size="80" type="text" placeholder="Curso"
                        ...
                        <div class="controls">
                            <div class="form-check">
                                <p class="form-check-label">
                                    <input class="form-check-input" type="radio" name="periodo" id="periodo"
                                           value="M" <?php echo ($periodo == "M") ? "checked" : null; ?>/> Masculino
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="periodo" id="periodo"
                                       value="F" <?php echo ($periodo == "F") ? "checked" : null; ?>/> Feminino
                            </div>
                            </p>
